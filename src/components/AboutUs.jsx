        ...
        <div className="md:flex md:items-start md:space-x-10">
          ...
          <div className="md:w-1/2 space-y-4 text-justify">
            <p>
              ...
              manage medical records, and we aim to make that process easier and
              faster.
            </p>
            <p>
              We are dedicated to delivering smart healthcare solutions through
              technology. Our platform is designed to simplify appointment
              booking, improve doctor-patient interaction, and provide reliable
              access to medical information — all in one place.
            </p>
            <div>
              ...
              <p>
                ...
                individuals with the right healthcare professionals at the right
                time, ensuring timely care and better health outcomes.
              </p>
            </div>
          </div>
        </div>
