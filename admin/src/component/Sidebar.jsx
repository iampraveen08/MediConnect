                    ...
                    <div className="flex flex-col flex-grow pt-5 overflow-y-auto bg-white border-r border-gray-50">
                        ...
                        <div className="flex flex-col flex-grow px-4">
                            <nav className="flex-1 space-y-1 bg-white">
                                <ul>
                                    <li>
                                        <a className="inline-flex items-center w-full px-4 py-2 mt-1 text-base text-gray-900 transition duration-500 ease-in-out transform rounded-lg bg-gray-50" href="#">
                                    ...
                                    <li>
                                        <a className="inline-flex items-center w-full px-4 py-2 mt-1 text-base text-gray-900 transition duration-500 ease-in-out transform rounded-lg hover:bg-gray-50" href="#">
                                            ...
                                            <span className="ml-4">Doctors List</span>
                                        </a>
                                    </li>
                                </ul>
